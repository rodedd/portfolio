...
const Menu = ({ openMenu }) => {
  return (
    <div className='md:hidden'>
      ...
      <div className='bg-white absolute top-2 right-0 w-4/5 h-72 z-20 rounded-lg flex flex-col p-4'>
        <div
        ...
        <ul className='flex flex-col justify-between items-center h-full text-xl'>
          <li>
            <Link to="/">Home</Link>
          </li>
          <li>
